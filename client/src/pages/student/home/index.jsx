...
const HERO_STATS = [
  { icon: Users,   value: "10,000+", label: "Active Students",  color: "#3b82f6" },
  { icon: BookOpen,value: "120+",    label: "Expert Courses",   color: "#a855f7" },
  { icon: Star,    value: "4.9★",    label: "Average Rating",   color: "#fbbf24" },
  { icon: Award,   value: "95%",     label: "Completion Rate",  color: "#06b6d4" },
];
...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    text: "From zero cloud experience to designing CI/CD pipelines in 8 weeks. The instruction quality here is world-class.",
    avatar: "RN",
    color: "#06b6d4",
  },
];
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-5 fade-up">
            <h3 className="text-xl font-bold" style={{ color: "#f0f9ff" }}>Why students choose Nexora Learn</h3>
            {[
              { icon: Rocket,       color: "#3b82f6", title: "Project-based training",    desc: "Work on live application builds with actual deliverables" },
              { icon: Award,        color: "#a855f7", title: "Industry certificates",      desc: "Verified credentials recognized by top technology firms" },
              { icon: Users,        color: "#06b6d4", title: "Expert instruction",        desc: "Interactive guidance from senior engineers in your field" },
              { icon: TrendingUp,   color: "#10b981", title: "95% completion rate",       desc: "Our students successfully master complex tech stacks" },
            ...
            >
              ...
              <div>
                <p className="text-sm font-bold" style={{ color: "#f0f9ff" }}>10,000+ students</p>
