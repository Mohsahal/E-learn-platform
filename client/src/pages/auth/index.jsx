...
function AuthPage() {
  ...
  const tabMeta = {
    ...
    signup: { icon: UserPlus,  label: "Join Nexora Learn",      sub: "Create your free account today" },
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex flex-col flex-1 relative overflow-hidden">
        ...
        >
          <TextLogo className="scale-150 origin-left" />
        </a>
      ...
      >
        ...
        <a href="/home" className="flex items-center justify-center mb-6 sm:mb-8 lg:hidden">
          <TextLogo className="scale-125" />
        </a>
