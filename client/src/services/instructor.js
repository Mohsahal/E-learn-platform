...
export async function requestCertificateService({ courseId, studentId }) {
  const { data } = await axiosInstance.post(`/secure/instructor/certificates/request`, { courseId, studentId });
  return data;
}
